...
<form action="{{ route('guru.update', $guru->id) }}" method="post">
    ...
    @method('put')
    <div class="row">
        <x-adminlte-input name="nik" label="NIK" placeholder="NIK guru" fgroup-class="col-md-6" value="{{ $guru->nik }}" />
        <x-adminlte-input name="nama" label="Nama" placeholder="Nama guru" fgroup-class="col-md-6" value="{{ $guru->nama }}" />
